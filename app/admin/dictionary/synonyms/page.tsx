...
export default function SynonymsAdminPage() {
  ...
  async function addWord() {
    ...
    try {
      ...
      showMessage(
        `“${cleanWord}” sinonimlar bazasiga qo‘shildi.`,
        "success"
      );
    } catch (error) {
      showMessage(
  ...
  function parseImportText(text: string) {
    ...
    for (const originalLine of lines) {
      ...
      const synonymText = parts
        .slice(2)
        .join("|")
        .trim();

      const synonymList =
        parseSynonyms(synonymText);
...
5. important | muhim | significant, essential, crucial`}
        />
      ...
      <section className="panel">
        <div className="dictionaryHeader">
          ...
          <input
            ...
            placeholder="So‘z, tarjima yoki sinonim qidirish..."
          />
        </div>
        ...
        {loading ? (
          ...
          <div className="statusBox">
            ...
            Yuqoridagi forma yoki ommaviy
            import orqali so‘z kiriting.
          </div>
        ) : filteredWords.length ===
          0 ? (
          <div className="statusBox">
