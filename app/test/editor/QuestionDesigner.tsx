...
function normalizeQuestionText(root: HTMLElement) {
  ...
  // Existing imported question HTML may contain old inline 16/18px sizes.
  // Normalize those ordinary text elements to the requested 24px on load/input.
  root.querySelectorAll("*").forEach((element) => {
    const el = element as HTMLElement;
    if (
      el.closest(".nc-object") ||
      el.hasAttribute("data-nc-ui")
    ) {
      return;
    }
